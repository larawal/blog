                ...
                <div class="m-portlet__head">
                    ...
                    <div class="m-portlet__head-wrapper">
                        ...
                        <div class="m-portlet__head-tools">
                            <a href="{{url('admin/articles')}}" class="btn btn-secondary m-btn m-btn--icon m-btn--wide m-btn--md m--margin-right-10">
                                <span>
                            ...
                            <div class="btn-group">
                                <a role="button" href="javascript:void(0);" onclick="articles.save();" class="btn btn-brand  m-btn m-btn--icon m-btn--wide m-btn--md">
                                    <span>
                                ...
                                <div class="dropdown-menu dropdown-menu-right">
                                    ...
                                    <a class="dropdown-item" href="javascript:void(0);" onclick="articles.save(true);">
