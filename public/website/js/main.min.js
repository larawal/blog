$(document).ready(function(){'use strict';$('.toggle_icon').on('click',function(){$('body').toggleClass('open');});$('#search_input_box').hide();$('#search').on('click',function(){$('#search_input_box').slideToggle('slow');$('#search_input').focus();});$('#close_search').on('click',function(){$('#search_input_box').slideUp('slow');});$('#horizontalTab').jqTabs({direction:'horizontal',duration:200});if(document.getElementById('default-select')){$('select').niceSelect();}
